...
This Jupyter notebook demonstrates basic methods for accessing and visualising the Narrabeen shoreline dataset.

The dataset is available via the Dryad repository:
https://doi.org/10.5061/dryad.70rxwdcd4
...
It provides simple examples for loading, inspecting, and working with the shoreline database.
